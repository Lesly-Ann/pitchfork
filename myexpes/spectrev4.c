...
/* The following test cases are probably not vulnerable to Spectrev4
   because the store that are supposed to be bypassed are fast. They
   can however be adapted following the method in case_1 to slow down
   the store to bypass */
